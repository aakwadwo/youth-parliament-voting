...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // A plain scrim. Blurring the page behind a confirmation dialog is
        // decoration, and it makes the thing you are being asked to confirm
        // harder to read at the exact moment you want to check it.
